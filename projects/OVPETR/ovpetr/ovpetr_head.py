...
from projects.OVPETR.petr.utils import normalize_bbox
...
class OVPETRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is OVPETRHead):
        ...
        super(OVPETRHead, self).__init__(
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is OVPETRHead:
            convert_dict = {
